    ...
    v-layout(row)
      v-flex(xs5, md4)
        v-toolbar.nav-header-inner(color='black', dark, flat, :class='$vuetify.rtl ? `pr-3` : `pl-3`')
          img(v-if='$vuetify.breakpoint.lgAndUp' @click='goHome' contain height='65' src='/_assets/img/rpp-logo-white.png')
          img(v-else-if='$vuetify.breakpoint.mdAndUp' @click='goHome' contain height='50' src='/_assets/img/rpp-logo-white.png')          
